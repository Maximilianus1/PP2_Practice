...
def paginated_navigation(limit=10, offset=0):
    while True:
        print("Navigating paginated results...")
        get_paginated(limit, offset)
        choice = input("Press 'n' for next page, 'p' for previous, 'q' to quit: ")
        if choice == 'n':
            offset += limit
